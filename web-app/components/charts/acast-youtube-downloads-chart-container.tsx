...
import AcastYouTubeDownloadsChart from "@/components/charts/acast-youtube-downloads-chart";

export default function AcastYouTubeDownloadsChartContainer({
  data,
}: {
  data: any;
}) {
    ...
    <div>
      <div className="flex items-center flex-col sm:flex-row mb-1">
        <div className="sm:mr-20">
          ...
          <p className="text-sm">
            Evolution journalière, hebdomadiare ou mensuelle du nombre de
            téléchargements (le nombre d'écoutes) du podcast selon l'épisode.
          </p>
        </div>
